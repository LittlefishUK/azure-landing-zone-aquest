...
A Log Analytics Workspace and Automation Account will be deployed to the resource group `rg-p-sentinel-uks`.  The inputs for this module are defined in `logging.parameters.all.json`.

This resource group will already need to exist, prior to deployment and can be created either via CLI or GUI
...
$inputObject = @{
  ...
  ResourceGroupName     = "rg-p-sentinel-ukw"
  TemplateFile          = "infra-as-code/bicep/modules/logging/logging.bicep"
