...
var varPlatformMg = {
  name: '${parTopLevelManagementGroupPrefix}-platformlz${parTopLevelManagementGroupSuffix}'
...
var varLandingZoneMg = {
  name: '${parTopLevelManagementGroupPrefix}-applicationlz${parTopLevelManagementGroupSuffix}'
...
resource resLandingZonesChildMgs 'Microsoft.Management/managementGroups@2023-04-01' = [for mg in items(varLandingZoneMgChildrenUnioned): if (!empty(varLandingZoneMgChildrenUnioned)) {
  name: '${parTopLevelManagementGroupPrefix}-applicationlz-${mg.key}${parTopLevelManagementGroupSuffix}'
  properties: {
...
resource resPlatformChildMgs 'Microsoft.Management/managementGroups@2023-04-01' = [for mg in items(varPlatformMgChildrenUnioned): if (!empty(varPlatformMgChildrenUnioned)) {
  name: '${parTopLevelManagementGroupPrefix}-platformlz-${mg.key}${parTopLevelManagementGroupSuffix}'
  properties: {
    displayName: mg.value.displayName
    details: {
      parent: {
